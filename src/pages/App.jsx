...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <Layout>
          <ExpandLessIcon className="scroll-top-btn" onClick={scrollToTop} 
          ...
          <Switch>
            ...
            <Route path="/team/founder" render={() => <Founders data={jsonData.Founders} /> } />
            <Route path="/team/executives" render={() => <Exe data={jsonData.Executives} /> } />
            <Route path="/team/advisory" render={() => <Advisory data={jsonData.Advisory} /> } />
    
            <Route path="/volunteers" render={()=> <VolunteersName 
