      ...
      <div id="instructions" style={{ padding: "4rem 0" }}>
        <Container className="container_section">
          ...
          <p>
            ...
            of any kind whether express or implied. In no event will ISET
            Foundation be liable for any damages including, without limitation,
            ...
            site, whether in contract or in negligence. ISET Foundation does not
            warrant that the functions contained in the material contained in
