                ...
                <section>
                    <Container>
                                    ...
                                    <Col className="advisory-card" key={index} lg='3'>
                                        <Card outline color="primary">
                                            <CardBody onClick={() => toggle(advisor)}>
                                                <img src={require(`../../../assets/img/members/${advisor.imgSrc}.jpg`).default} alt={advisor.id} />
                        ...
                        <Modal isOpen={modal.state} 
                            ...
                            size="lg">
                            <ModalHeader>{modal.name} - {modal.desg}</ModalHeader>
