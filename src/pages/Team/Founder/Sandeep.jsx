        ...
        <Container>
          <Row>
            {props.data.map((Founder, index) => {
              if (Founder.id === "sandeep_singh")
                return (
                  <div
                    key={index}
                    className={`founder-${props.class} member-card`}
                  >
                    <Row className="mem-card-head">
                      <Col lg="9">
                        ...
                        {Object.keys(Founder.links).length !== 0 ? (
                          <div className="icons">
                            ...
                            <a
                              href={Founder.links.researchGate}
                              target="_blank"
                              rel="noreferrer"
                            >
                      ...
                      <Col lg="3">
                        <img
                          src={
                            require(`../../../assets/img/members/${Founder.imgSrc}.jpg`)
                              .default
                          }
                          alt={Founder.name}
                        />
