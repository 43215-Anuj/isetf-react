    ...
    const slides = items.map((item) => {
        return (
          ...
          >
            ...
            <CarouselCaption className="text-danger" captionText={item.text} captionHeader={item.caption} />
          </CarouselItem>
        );
    });
                  ...
                  <Row>
                    <Col lg='6'>
                      <div className="mission-la"
                        ...
                        <WifiTetheringIcon />
                        <h4>Awareness</h4>
                        <p>ISET Foundation promotes scientific culture among students and make them aware about its importance in the human welfare and development.</p>
                      </div>
                    </Col>
                    <Col lg='6'>
                      <div className="mission-ra"
                        ...
                        <p>ISET Foundation ensures that all children not only study the theory but also strictly do the practical work in the school.</p>
                      </div>
                    </Col>
                  </Row>
                </Container>
            ...
            <section id="glance">
                <Container>
                  <div className="sec-heading">
                    ...
                    <p>ISET Foundation works nationally to promote Science Education in India. The foundation is keenly interested to develop the scientific temperament in each student of India and to develop the scientific-technological atmosphere in the community.</p>
                  </div>
                  ...
                  <Row>
                    <Col lg="4" sm='12'>
                      <div className="glance-card" 
                        ...
                        <p>ISET Fundation used to organize the health camps time to time in order to ensure that everyone get access to medical facilities.We alsporganizes several environment progames for the betterment of society.</p>
                      </div>
                    </Col>
                    <Col lg="4" sm='12'>
                      <div className="glance-card" 
                        ...
                        <p>We spread awareness among students towards the importance of science and technology in the era of today through the scientific sessions organized at their schools. The key role of such programmes is to encourage more and more students towards science and technology.</p>
                      </div>
                    </Col>
                    <Col lg="4" sm='12'>
                      <div className="glance-card glance-right"
                        ...
                        <p>ISET Foundation produces environmental education resources lik publications, CD-ROMs and posters for primary and secondary school teachers...</p>
                      </div>
                    </Col>
                  </Row>
                </Container>
            ...
            <section>
              ...
              <section style={{backgroundColor: 'var(--theme-yellow)'}}>
                <div className="sec-heading">
                    ...
                    <Container>
                      <p>ISET Foundation’s Members are self-motivated people of all ages and from different walks of life who give of their time and resources to make positive difference in the science education of students and society. Come, be an ISET Foundation member.</p>

                      <Button color="info"
                        style={{fontFamily: 'Montserrat-SemiBold',
                        color: '#fff'}}>JOIN AS MEMBER</Button>
                    </Container>
                </div>
            </section>
            <Footer />
